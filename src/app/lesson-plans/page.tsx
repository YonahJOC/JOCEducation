...
export default async function LessonPlansPage() {
  ...
  return (
    <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "48px 26px 64px" }}>
      <p style={{ ...label, color: C.orangeText, marginBottom: "10px" }}>LESSON LIBRARY</p>
      <h1 style={{ fontWeight: 800, fontSize: "clamp(32px, 4.5vw, 52px)", lineHeight: 1.04, letterSpacing: "-0.04em", color: C.ink, marginBottom: "12px" }}>
        Every lesson plan we have.
      </h1>
      <p style={{ fontSize: "17px", color: C.muted, lineHeight: 1.6, maxWidth: "56ch", marginBottom: "40px" }}>
