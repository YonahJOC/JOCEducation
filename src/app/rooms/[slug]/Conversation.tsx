    ...
    <div>
      ...
      {canPost && !replying && !gone && (
        <button
          ...
          style={{ fontFamily: "var(--font-outfit)", fontSize: "13px", fontWeight: 600, color: C.blue, background: "none", border: "none", cursor: "pointer", padding: "8px 0 0", marginLeft: m.replies.length > 0 ? "40px" : "52px", minHeight: "40px" }}
        >
          Reply
        </button>
      )}
