    ...
    <div>
      ...
      <div style={{ backgroundColor: "#10233F", padding: "64px 26px 56px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <p style={{ fontWeight: 700, fontSize: "11.5px", letterSpacing: "0.22em", textTransform: "uppercase", color: "#F7941D", marginBottom: "12px" }}>CHESED PROGRAMS</p>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "52px 26px 0" }}>
        ...
        <div style={{ backgroundColor: "#fff", borderRadius: "26px", border: "1px solid rgba(16,35,63,.1)", padding: "34px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "34px", marginBottom: "64px" }}>
          <div>
            ...
            <Link href="/pricing" style={{ display: "inline-block", backgroundColor: "#1E47B8", color: "#fff", fontWeight: 700, fontSize: "14.5px", borderRadius: "9999px", padding: "13px 24px", textDecoration: "none" }}>
              See pricing
            </Link>
          </div>
            ...
            {JOC_PROGRAMS.map((p) => (
              <div key={p.key} style={{ backgroundColor: "#fff", borderRadius: "22px", border: "1px solid rgba(16,35,63,.1)", padding: "26px", display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  {p.external ? (
                    <a href={p.href} target="_blank" rel="noopener noreferrer" style={{ flex: 1, display: "block", textAlign: "center", backgroundColor: "#F7941D", color: "#10233F", fontWeight: 700, fontSize: "13.5px", borderRadius: "9999px", padding: "10px 16px", textDecoration: "none" }}>
                      Visit ↗
                    </a>
                  ) : (
                    <Link href="/pricing" style={{ flex: 1, display: "block", textAlign: "center", backgroundColor: "#1E47B8", color: "#fff", fontWeight: 700, fontSize: "13.5px", borderRadius: "9999px", padding: "10px 16px", textDecoration: "none" }}>
                      Register
                    </Link>
                  )}
                </div>
        ...
        {/* CTA band */}
        <div style={{ backgroundColor: "#1E47B8", borderRadius: "26px", padding: "44px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "24px", marginBottom: "40px" }}>
          <div>
